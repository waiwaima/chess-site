          ...
          v-container.tournament(fill-height fluid)
            v-layout(column)
              v-flex(xs12 align-end flexbox)
                  span.name 1st Boston Elite Chess Tournament
              v-flex(xs12 align-end flexbox)
                v-layout(column justify-center)
                  span.detail Sunday, February 11, 2018
              v-flex(xs12 align-end flexbox)
                v-layout(column)
        ...
        v-card.first
          v-layout(column align-start)
            ...
            div.content
              ...
              ul.ml-4
                li $45 by 1/20, $55 by 2/10, $65 onsite
        ...
        v-card.other
          v-layout(column align-start)
            ...
            div.content
              span.subtitle Entry Fee:
              ul.ml-4
                li $35 by 1/20, $45 by 2/10, $55 onsite
