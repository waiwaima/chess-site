...
<style lang="stylus">
.quads-player .tabs .tabs__item.tabs__item--active
  color: white !important
  font-weight: 600
.quads-player .tabs .tabs__li
  border-radius: 2px
  width: 100px
  color: white
  background-color: #3497f0
.quads-player .tabs__li
  margin: 2px
  width: auto
.quads-player .tabs__slider
  height: 3px
.quads-player #section .tabs__content
  transition: none
.quads-player table.table tbody td
  height: 40px
.quads-player table.table tbody td:first-child, .quads-player table.table thead th:first-child
  padding: 0 0 0 24px
</style>
